...
<main id="main" class="main youtube-new">
        ...
        <div class="container">
            <div class="row mx-auto">
                <div class="col-12 col-xl-5 content-column column order-1">
                    ...
                    <a href="tel:09190106414" type="button" class="btn btn-outline-primary">تماس با ما</a>
                </div>
	...
	<script type="application/ld+json">
		...
		"mainEntity": [
			{
			"@type": "Question",
			"name": "هزینه ها به چه شکل محاسبه می شوند؟",
			"acceptedAnswer": {
				"@type": "Answer",
				"text": "هزینه ی تبلیغات در یوتیوب، یا به ازای هر 1000 عدد نمایش است، یا به ازای کلیک و مشاهده ی حداقل 30 ثانیه از تبلیغات"
			}
			},
			{
			"@type": "Question",
			"name": "با خرید هر پلن چه تعداد به سابسکرایبر ها اضافه می شود؟",
			"acceptedAnswer": {
				"@type": "Answer",
				"text": "این عدد کاملا بسته به ظاهر چنل شما، تعداد ویدئوها، تعداد سابسکرایبر های فعلی و موضوع محتوای شما دارد. اما اگر در نظر بگیریم که چنل شما از لحاظ محتوا کیفیت بالایی دارد، با خرید 500 درهم، بین 500 تا 2000 سابسکرایبر قابل جذب است."
			}
			},
			{
			"@type": "Question",
			"name": "آیا باید حتما برای تبلیغات در یوتیوب، کانال داشته باشیم؟",
			"acceptedAnswer": {
				"@type": "Answer",
				"text": "بله. ویدئوی تبلیغی شما باید در کانال یوتیوب آپلود شده باشد. این ویدئو می تواند بصورت شخصی آپلود شود و برای دیگران قابل رویت نباشد."
			}
			},
			{
			"@type": "Question",
			"name": "با توجه به فیلتر بودن یوتیوب، به چه شکل می توان کاربران ایرانی را انتخاب کرد؟",
			"acceptedAnswer": {
				"@type": "Answer",
				"text": "با انتخاب دقیق کانال ها و ویدئوهای مرتبط با حوزه فعالیت شما که به زبان فارسی هستند، برای نمایش تبلیغ، این مساله ممکن می شود."
			}
			},
			{
			"@type": "Question",
			"name": "آیا از تبلیغات یوتیوب برای معرفی وب سایت هم می توان استفاده کرد؟",
			"acceptedAnswer": {
				"@type": "Answer",
				"text": "بله قابل استفاده است. شما می توانید ویدئو تبلیغ خود را به وب سایت لینک نموده و از این تبلیغ ورودی به وب سایت خود داشته باشید."
			}
			}
		]
		}
